...
UINT8X Ep2Buffer[MIN(64, ENDP2_IN_SIZE + 2)] _at_ MIN(64, THIS_ENDP0_SIZE + 2); // 端点2 IN&OUT缓冲区,必须是偶地址
...
UINT8X UserEp2Buf[64] = {0x07, 0x0d, 0x00}; // 用户数据定义
UINT8 Endp2Busy = 0;
...
void Enp2IntIn()
{
    ...
    UEP2_T_LEN = 3;                                                      // THIS_ENDP0_SIZE;                                        // 上传最大包长度
